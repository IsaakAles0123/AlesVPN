...
internal object CelestialGlobeData {
    ...
    val namedConstellations: List<Constellation> = listOf(
        ...
        /** Сердце в свободном секторе (между классическими группами), хорошо читается на куполе. */
        Constellation(
            "Samira",
            listOf(
                35f to 43f, // левый верхний выступ
                38f to 49f, // впадина между «половинками»
                35f to 55f, // правый верхний выступ
                31f to 55f, // правый бок
                25f to 50f, // нижняя точка
                31f to 44f, // левый бок
            ),
            listOf(0 to 1, 1 to 2, 2 to 3, 3 to 4, 4 to 5, 5 to 0),
        ),
    )
