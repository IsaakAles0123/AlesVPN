...
internal object CelestialGlobeData {
    ...
    val namedConstellations: List<Constellation> = listOf(
        ...
        /**
         * Сердце: параметрическая кривая (sin³/cos), разложена в lat/lon вокруг (-38°, 31°), слева на куполе.
         * Замкнутый контур из 18 точек — читаемая форма после проекции сферы.
         */
        Constellation(
            "Samira",
            listOf(
