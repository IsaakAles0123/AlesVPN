...
internal object CelestialGlobeData {
    ...
    val namedConstellations: List<Constellation> = listOf(
        ...
        /** Сердце: отрицательная долгота — на куполе слева (видимый диск). */
        Constellation(
            "Samira",
            listOf(
                35f to -44f, // левый верхний выступ
                38f to -38f, // впадина между «половинками»
                35f to -32f, // правый верхний выступ
                31f to -32f, // правый бок
                25f to -37f, // нижняя точка
                31f to -43f, // левый бок
            ),
            listOf(0 to 1, 1 to 2, 2 to 3, 3 to 4, 4 to 5, 5 to 0),
        ),
    )
